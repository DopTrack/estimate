...
def create_propagator_settings(initial_state, initial_time, final_time, bodies, acceleration_models, save_accelerations=False,
...
def propagate_initial_state(initial_state, initial_time, final_time, bodies, acceleration_models,
    ...
    single_arc_propagator_settings = create_propagator_settings(initial_state, initial_time, final_time, bodies, acceleration_models,
                                                                save_accelerations, accelerations_to_save)

    # Propagate dynamics
    simulator = numerical_simulation.SingleArcSimulator(bodies, integrator_settings, single_arc_propagator_settings, 1,
                                                        0, 1)
...
def define_multi_arc_propagation_settings(arc_wise_initial_states, arc_start_times, arc_end_times, bodies, acceleration_models):
    bodies_to_propagate = ["Delfi"]
    central_bodies = ["Earth"]
